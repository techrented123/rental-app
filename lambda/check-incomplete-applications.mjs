/**
 * AWS Lambda function to check incomplete applications
 * Triggered by EventBridge every 30 minutes
 * Calls the Next.js API endpoint hosted on Amplify
 *
 * ES6 Module version - Use this file (.mjs) for Lambda deployment
 */
